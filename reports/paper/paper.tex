...
visualized in Figure~\ref{fig:unifmap}. We turn to the figure now.
% \begin{itemize}
...
Bottom row: softmax model. \emph{In the grids, the southern border of Central Park lies
approximately three-sevenths of the way up}}
\label{fig:unifmap}
\end{figure}
...
of different weather conditions on road congestion could be measured. Similarly,
